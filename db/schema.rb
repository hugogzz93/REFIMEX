...
ActiveRecord::Schema.define(version: 20_170_220_221_834) do
  ...
  create_table 'modifiers', force: :cascade do |t|
    ...
    t.index ['product_id'], name: 'index_modifiers_on_product_id', using: :btree
    t.index ['user_id'], name: 'index_modifiers_on_user_id', using: :btree
  end
